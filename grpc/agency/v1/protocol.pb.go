...
type Protocol struct {
	...
	TypeId       Protocol_Type `protobuf:"varint,1,opt,name=type_id,json=typeId,proto3,enum=agency.v1.Protocol_Type" json:"type_id,omitempty"` // Protocol type
...
func (x *Protocol) GetDIDExchange() *Protocol_Connection {
...
func (x *Protocol) GetPresentProof() *Protocol_ProofRequest {
...
type Protocol_DIDExchange struct {
	DIDExchange *Protocol_Connection `protobuf:"bytes,10,opt,name=DID_exchange,json=DIDExchange,proto3,oneof"`
}

type Protocol_IssueCredential struct {
	IssueCredential *Protocol_Issuing `protobuf:"bytes,11,opt,name=IssueCredential,proto3,oneof"`
}

type Protocol_PresentProof struct {
	PresentProof *Protocol_ProofRequest `protobuf:"bytes,12,opt,name=PresentProof,proto3,oneof"`
}
...
type ProtocolID struct {
	...
	TypeId           Protocol_Type `protobuf:"varint,1,opt,name=type_id,json=typeId,proto3,enum=agency.v1.Protocol_Type" json:"type_id,omitempty"`  // i.e. what is going on
...
type Protocol_Connection struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *Protocol_Connection) Reset() {
	*x = Protocol_Connection{}
	if protoimpl.UnsafeEnabled {
...
func (x *Protocol_Connection) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Protocol_Connection) ProtoMessage() {}

func (x *Protocol_Connection) ProtoReflect() protoreflect.Message {
	mi := &file_protocol_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Protocol_Connection.ProtoReflect.Descriptor instead.
func (*Protocol_Connection) Descriptor() ([]byte, []int) {
	return file_protocol_proto_rawDescGZIP(), []int{0, 2}
}

func (x *Protocol_Connection) GetLabel() string {
	if x != nil {
		return x.Label
	}
	return ""
...
func (x *Protocol_Connection) GetInvitationJson() string {
	if x != nil {
...
type Protocol_ProofRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Types that are assignable to AttrFmt:
	//	*Protocol_ProofRequest_AttributesJson
	//	*Protocol_ProofRequest_Attrs
	AttrFmt isProtocol_ProofRequest_AttrFmt `protobuf_oneof:"AttrFmt"`
}

func (x *Protocol_ProofRequest) Reset() {
	*x = Protocol_ProofRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *Protocol_ProofRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Protocol_ProofRequest) ProtoMessage() {}

func (x *Protocol_ProofRequest) ProtoReflect() protoreflect.Message {
	mi := &file_protocol_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Protocol_ProofRequest.ProtoReflect.Descriptor instead.
func (*Protocol_ProofRequest) Descriptor() ([]byte, []int) {
	return file_protocol_proto_rawDescGZIP(), []int{0, 5}
}

func (m *Protocol_ProofRequest) GetAttrFmt() isProtocol_ProofRequest_AttrFmt {
	if m != nil {
		return m.AttrFmt
	}
	return nil
...
func (x *Protocol_ProofRequest) GetAttributesJson() string {
	if x, ok := x.GetAttrFmt().(*Protocol_ProofRequest_AttributesJson); ok {
		return x.AttributesJson
	}
	return ""
}

func (x *Protocol_ProofRequest) GetAttrs() *Protocol_Proof {
	if x, ok := x.GetAttrFmt().(*Protocol_ProofRequest_Attrs); ok {
		return x.Attrs
	}
	return nil
}

type isProtocol_ProofRequest_AttrFmt interface {
	isProtocol_ProofRequest_AttrFmt()
}

type Protocol_ProofRequest_AttributesJson struct {
	AttributesJson string `protobuf:"bytes,1,opt,name=attributes_json,json=attributesJson,proto3,oneof"`
}

type Protocol_ProofRequest_Attrs struct {
	Attrs *Protocol_Proof `protobuf:"bytes,2,opt,name=attrs,proto3,oneof"`
}

func (*Protocol_ProofRequest_AttributesJson) isProtocol_ProofRequest_AttrFmt() {}

func (*Protocol_ProofRequest_Attrs) isProtocol_ProofRequest_AttrFmt() {}
...
func (x *Protocol_Proof_Attr) GetCredDefId() string {
	if x != nil {
		return x.CredDefId
	}
	return ""
...
var file_protocol_proto_rawDesc = []byte{
	...
	0x12, 0x09, 0x61, 0x67, 0x65, 0x6e, 0x63, 0x79, 0x2e, 0x76, 0x31, 0x22, 0xb7, 0x09, 0x0a, 0x08,
	0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x12, 0x31, 0x0a, 0x07, 0x74, 0x79, 0x70, 0x65,
	0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x18, 0x2e, 0x61, 0x67, 0x65, 0x6e,
	0x63, 0x79, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2e, 0x54,
	0x79, 0x70, 0x65, 0x52, 0x06, 0x74, 0x79, 0x70, 0x65, 0x49, 0x64, 0x12, 0x2c, 0x0a, 0x04, 0x72,
	...
	0x76, 0x5f, 0x74, 0x68, 0x72, 0x65, 0x61, 0x64, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0c, 0x70, 0x72, 0x65, 0x76, 0x54, 0x68, 0x72, 0x65, 0x61, 0x64, 0x49, 0x64, 0x12,
	...
	,
	...
	,
	...
	0x6f, 0x6c, 0x49, 0x44, 0x12, 0x31, 0x0a, 0x07, 0x74, 0x79, 0x70, 0x65, 0x5f, 0x69, 0x64, 0x18,
	...
	0x06, 0x74, 0x79, 0x70, 0x65, 0x49, 0x64, 0x12, 0x2c, 0x0a, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x18,
	...
	0x04, 0x72, 0x6f, 0x6c, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x2b, 0x0a, 0x11, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63,
	...
	0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x61, 0x67, 0x65, 0x6e,
	0x63, 0x79, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x49, 0x44,
	0x52, 0x0a, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x49, 0x64, 0x12, 0x34, 0x0a, 0x05,
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x15, 0x0a, 0x06, 0x6d,
	...
	0x12, 0x1e, 0x0a, 0x0b, 0x63, 0x72, 0x65, 0x64, 0x5f, 0x64, 0x65, 0x66, 0x5f, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x63, 0x72, 0x65, 0x64, 0x44, 0x65, 0x66, 0x49, 0x64,
	0x12, 0x1b, 0x0a, 0x09, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x08, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x49, 0x64, 0x12, 0x33, 0x0a,
...
var file_protocol_proto_goTypes = []interface{}{
	...
	(*Protocol_Connection)(nil),         // 9: agency.v1.Protocol.Connection
	(*Protocol_Issuing)(nil),            // 10: agency.v1.Protocol.Issuing
	(*Protocol_Proof)(nil),              // 11: agency.v1.Protocol.Proof
	(*Protocol_ProofRequest)(nil),       // 12: agency.v1.Protocol.ProofRequest
...
var file_protocol_proto_depIdxs = []int32{
	...
	9,  // 2: agency.v1.Protocol.DID_exchange:type_name -> agency.v1.Protocol.Connection
	10, // 3: agency.v1.Protocol.IssueCredential:type_name -> agency.v1.Protocol.Issuing
	12, // 4: agency.v1.Protocol.PresentProof:type_name -> agency.v1.Protocol.ProofRequest
	...
	11, // 18: agency.v1.Protocol.ProofRequest.attrs:type_name -> agency.v1.Protocol.Proof
...
func file_protocol_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_protocol_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Protocol_Connection); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_protocol_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Protocol_ProofRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_protocol_proto_msgTypes[9].OneofWrappers = []interface{}{
		(*Protocol_ProofRequest_AttributesJson)(nil),
		(*Protocol_ProofRequest_Attrs)(nil),
	}
	type x struct{}
