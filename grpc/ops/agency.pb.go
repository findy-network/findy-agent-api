...
import (
	agency "github.com/findy-network/findy-agent-api/grpc/agency"
...
type AgencyStatus struct {
	...
	ProtocolStatus *agency.ProtocolStatus `protobuf:"bytes,2,opt,name=protocol_status,json=protocolStatus,proto3" json:"protocol_status,omitempty"` // Detailed protocol information
	DID            string                 `protobuf:"bytes,3,opt,name=DID,proto3" json:"DID,omitempty"`                                             // Agent DID if available
	ConnectionId   string                 `protobuf:"bytes,4,opt,name=connection_id,json=connectionId,proto3" json:"connection_id,omitempty"`       // Connection (pairwise) ID if available
}
...
func (x *AgencyStatus) GetProtocolStatus() *agency.ProtocolStatus {
	if x != nil {
...
type Cmd struct {
	...
	Type Cmd_Type `protobuf:"varint,1,opt,name=type,proto3,enum=ops.Cmd_Type" json:"type,omitempty"`
...
var file_agency_proto_rawDesc = []byte{
	,
	...
	0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x10, 0x0a,
	0x03, 0x44, 0x49, 0x44, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x44, 0x49, 0x44, 0x12,
	...
	0x6f, 0x6e, 0x49, 0x64, 0x22, 0x1a, 0x0a, 0x08, 0x44, 0x61, 0x74, 0x61, 0x48, 0x6f, 0x6f, 0x6b,
	0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64,
	0x22, 0x79, 0x0a, 0x03, 0x43, 0x6d, 0x64, 0x12, 0x21, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0d, 0x2e, 0x6f, 0x70, 0x73, 0x2e, 0x43, 0x6d, 0x64, 0x2e,
	...
	,
	...
	0x70, 0x63, 0x2f, 0x6f, 0x70, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_agency_proto_goTypes = []interface{}{
	(Cmd_Type)(0),                  // 0: ops.Cmd.Type
	(*Onboarding)(nil),             // 1: ops.Onboarding
	(*OnboardResult)(nil),          // 2: ops.OnboardResult
	(*AgencyStatus)(nil),           // 3: ops.AgencyStatus
	(*DataHook)(nil),               // 4: ops.DataHook
	(*Cmd)(nil),                    // 5: ops.Cmd
	(*CmdReturn)(nil),              // 6: ops.CmdReturn
	(*OnboardResult_OkResult)(nil), // 7: ops.OnboardResult.OkResult
	(*agency.ProtocolStatus)(nil),  // 8: agency.ProtocolStatus
}
var file_agency_proto_depIdxs = []int32{
	7, // 0: ops.OnboardResult.result:type_name -> ops.OnboardResult.OkResult
	8, // 1: ops.AgencyStatus.protocol_status:type_name -> agency.ProtocolStatus
	0, // 2: ops.Cmd.type:type_name -> ops.Cmd.Type
	0, // 3: ops.CmdReturn.type:type_name -> ops.Cmd.Type
	4, // 4: ops.Agency.PSMHook:input_type -> ops.DataHook
	1, // 5: ops.Agency.Onboard:input_type -> ops.Onboarding
	5, // 6: ops.DevOps.Enter:input_type -> ops.Cmd
	3, // 7: ops.Agency.PSMHook:output_type -> ops.AgencyStatus
	2, // 8: ops.Agency.Onboard:output_type -> ops.OnboardResult
	6, // 9: ops.DevOps.Enter:output_type -> ops.CmdReturn
